  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          This privacy policy applies to the Rogha app (hereby referred to as
          &ldquo;Application&rdquo;) for mobile devices that was created by Dylan Walsh
          (hereby referred to as &ldquo;Service Provider&rdquo;) as an Open Source
          service. This service is intended for use &ldquo;AS IS&rdquo;.
        </p>

        <h2 className="text-xl font-serif pt-4">Information Collection and Use</h2>
        ...
        <p>
          ...
          including but not limited to email address, first name, last name, username,
          display name, bio, profile photo, location (user-provided), website URL
          (user-provided), user-generated posts, comments, likes and reactions, circles,
          friend connections, follows, notification preferences, push notification device
          tokens, edition view records, internal activity event logs, account creation
          date, last profile update date. The information that the Service Provider
          request will be retained by them and used as described in this privacy policy.
        </p>

        <h2 className="text-xl font-serif pt-4">Third Party Access</h2>
        ...
        <h2 className="text-xl font-serif pt-4">Opt-Out Rights</h2>
        ...
        <h2 className="text-xl font-serif pt-4">Data Retention Policy</h2>

        <p>
          The Service Provider will retain User Provided data for as long as you use the
          Application and for a reasonable time thereafter. If you&apos;d like them to
        ...
        <h2 className="text-xl font-serif pt-4">Children</h2>
        ...
        <p>
          ...
          children under 13 years of age. In the case the Service Provider discover that
          a child under 13 has provided personal information, the Service Provider will
        ...
        <h2 className="text-xl font-serif pt-4">Security</h2>
        ...
        <h2 className="text-xl font-serif pt-4">Changes</h2>
        ...
        <p>
          ...
          updating this page with the new Privacy Policy. You are advised to consult this
          Privacy Policy regularly for any changes, as continued use is deemed approval
          of all changes.
        </p>

        <p>This privacy policy is effective as of 2025-01-12.</p>

        <h2 className="text-xl font-serif pt-4">Your Consent</h2>
        ...
        <h2 className="text-xl font-serif pt-4">Contact Us</h2>
