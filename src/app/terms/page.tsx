  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          These terms and conditions apply to the Rogha app (hereby referred to as
        ...
        <p>
          ...
          Service Provider strongly advise against jailbreaking or rooting your phone,
        ...
        <ul className="list-disc pl-6">
          <li>
            <Link href="https://clerk.com/terms" className="underline" target="_blank" rel="noopener noreferrer">
              Clerk
            </Link>
          </li>
        </ul>
        ...
        <p>
          ...
          your mobile network provider&apos;s agreement terms still apply. Consequently,
        ...
        <p>
          ...
          guarantee that it will always update the application so that it is relevant
          to you and/or compatible with the particular operating system version installed
          on your device. However, you agree to always accept updates to the application
          when offered to you. The Service Provider may also wish to cease providing
        ...
        <p>These terms and conditions are effective as of 2025-01-12.</p>
